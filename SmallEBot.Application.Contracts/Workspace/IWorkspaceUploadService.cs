...
/// ReplacedOldPath is set when a duplicate (same hash) was deduplicated by renaming the existing file.
/// </summary>
...
/// <summary>
/// Service for chunked workspace file upload with temp staging and hash deduplication.
/// </summary>
public interface IWorkspaceUploadService
{
    /// <summary>
    /// Starts a new chunked upload. Returns upload ID.
    /// Throws if file extension is not allowed.
    /// </summary>
    ...
    /// <summary>
    /// Appends a chunk of data to an in-progress upload.
    /// </summary>
    ...
    /// <summary>
    /// Completes an upload: closes stream, computes hash, deduplicates, and moves to temp.
    /// Returns result or null if upload not found.
    /// </summary>
    ...
    /// <summary>
    /// Cancels an in-progress upload and removes staging file.
    /// </summary>
