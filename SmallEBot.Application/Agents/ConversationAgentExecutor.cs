...
/// Implemented in Application.Agents; consumed by Host.
/// </summary>
public sealed class ConversationAgentExecutor(
    ...
    IAmbientConversationId ambientConversationId) : IConversationAgentExecutor
{
